...
function loadPage(pagina) {
    ...
    fetch(`../src/actions/ajax/ajax_catalogo_animes.php?${params.toString()}`)
        ...
        .catch(function(error) {
            ...
            if (resultsContainer) {
                resultsContainer.innerHTML = '<div class="error">Error al cargar los animes. Revisa la consola de desarrollo.</div>';
            }
        });
}
